...
public static class LogHelper
{
    ...
    private const string MessageBusEmoji = "🐰";
...
╚══════════════════════════════════════════════════════════════╝";
    ...
    public static void LogMessageBus(string message)
    {
        Log.Information("{Emoji} Message Bus: {Message}", MessageBusEmoji, message);
    }
...
║  Thank you for using Order Service! {SuccessEmoji}                      ║
╚══════════════════════════════════════════════════════════════╝";
